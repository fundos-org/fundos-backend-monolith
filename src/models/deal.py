...
class Industry(str, Enum):
    AEROSPACE = "aerospace"
    AGRITECH_AND_AGRICULTURE = "agritech_and_agriculture"
    ARTIFICIAL_INTELLIGENCE = "artificial_intelligence"
    AUTOMOTIVE = "automotive"
    CONSUMER_ELECTRONICS = "consumer_electronics"
    DEEP_TECH = "deep_tech"
    EDTECH_AND_EDUCATION = "edtech_and_education" 
    FINTECH_AND_FINANCIAL_SERVICES = "fintech_and_financial_services"
    FOOD_INDUSTRY_SERVICES = "food_industury_services"
    GAMING = "gaming"
    GOVERNMENT = "government"
    HEALTHTECH_AND_MEDTECH = "heathcare_and_medtech"
...
class Deal(SQLModel, table=True):
    ...
    investment_scheme_appendix: str = Field(default=None, nullable=True)
    ...
    user_preferences: List["UserDealPreference"] = Relationship(back_populates="deal") # type: ignore  # noqa: F821
